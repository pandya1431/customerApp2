...
const BottomNavigationBar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50 shadow-lg safe-area-pb">
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-xs font-medium text-center leading-tight truncate max-w-full px-1">
                {item.name}
              </span>
            </Link>
          );
