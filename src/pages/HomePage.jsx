...
const HomePage = ({ searchQuery }) => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Main Content */}
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 pt-3 pb-20 md:pb-4">
            ...
            >
              {bannerSlides.map((slide, index) => (
                ...
                >
                  ...
                  {/* Slide Content */}
                  <div className="relative z-10 p-3 sm:p-4 md:p-6 h-full flex justify-between items-start">
                    {/* Left Content */}
                    <div className="flex flex-col justify-between h-full">
                      ...
                      {/* Pagination Dots */}
                      <div className="flex space-x-1.5 mt-2 md:mt-4">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-6 mb-4 md:mb-8">
          ...
          >
            <Zap className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-emerald-600 mb-1 sm:mb-2 md:mb-3 group-hover:scale-110 transition-transform" />
          ...
          <Link
            ...
            className="flex flex-col items-center p-3 sm:p-4 md:p-6 bg-gray-50 rounded-lg md:rounded-xl hover:bg-gray-100 transition-colors group"
          >
            <Globe className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-emerald-600 mb-1 sm:mb-2 md:mb-3 group-hover:scale-110 transition-transform" />
          ...
          <Link
            ...
            className="flex flex-col items-center p-3 sm:p-4 md:p-6 bg-gray-50 rounded-lg md:rounded-xl hover:bg-gray-100 transition-colors group"
          >
            <Store className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-emerald-600 mb-1 sm:mb-2 md:mb-3 group-hover:scale-110 transition-transform" />
        ...
        <div className="mb-4 md:mb-8">
          <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-3 md:mb-6">
            Recommended Products
          </h2>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
              {featuredProducts.map((product) => (
                <div key={product.id} className="bg-white rounded-lg p-2 sm:p-3 md:p-4 hover:shadow-lg transition-shadow">
                  ...
                  <p className="text-xs sm:text-sm md:text-base font-bold text-gray-900">{formatCurrency(product.price)}</p>
                </div>
              ))}
            </div>
          )}
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-6">
            <div className="bg-gradient-to-r from-red-400 to-red-500 rounded-lg md:rounded-xl p-3 sm:p-4 md:p-6 text-white flex flex-col items-center hover:shadow-lg transition-shadow">
              <Zap className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 mb-1 sm:mb-2 md:mb-3" />
            ...
            <div className="bg-gray-50 rounded-lg md:rounded-xl p-3 sm:p-4 md:p-6 flex flex-col items-center hover:bg-gray-100 transition-colors">
              <ShoppingCart className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 text-emerald-600 mb-1 sm:mb-2 md:mb-3" />
              <span className="text-xs sm:text-sm md:text-base font-medium text-gray-900 text-center">Grocery</span>
            </div>
            <div className="bg-gray-50 rounded-lg md:rounded-xl p-3 sm:p-4 md:p-6 flex flex-col items-center hover:bg-gray-100 transition-colors">
              <Coffee className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 text-emerald-600 mb-1 sm:mb-2 md:mb-3" />
